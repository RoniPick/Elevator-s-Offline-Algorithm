...
class Offline_Algo:
    ...
    def main_function(Building_File, Calls_File, output_File): # the main function of the program. we receive the files and we will need to return a new file
    ...
    def allocate_call(calls, []) # this function will get a list of calls /a single call and allocate the call at an elevator
    ...
    def best_time():  # this call will tell us which elevator is the best for the specific call
    ...
    def calculate_time(calls,elevator): # this function will calculate the total time for a call in specific elevator
